...
CPU 0:
   ...
   processor serial number = 000B-06A3-0000-0000-0000-0000
   deterministic cache parameters (4):
      ...
      maximum IDs for cores in pkg       = 0x1f (31)
   ...
   extended feature flags (7):
      ...
      AVX-COMPLEX instructions                 = false
   ...
   XSAVE features (0xd/0):
      ...
      SAVE area size in bytes                 = 0x00000680 (1664)
   ...
   brand = "13th Gen Intel(R) Core(TM) i3-1315U"
   ...
   (uarch synth) = Intel Raptor Cove {optim of Golden Cove}, Intel 7
   (synth) = Intel Core i*-13000 P-core (Raptor Lake-P Q0) [Raptor Cove] {optim of Golden Cove}, Intel 7
CPU 1:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      processor type  = primary processor (0)
...
CPU 4:
   ...
   Processor Frequency Information (0x16):
      Core Base Frequency (MHz) = 0x9c4 (2500)
      Core Maximum Frequency (MHz) = 0xce4 (3300)
      Bus (Reference) Frequency (MHz) = 0x64 (100)
   System-On-Chip Vendor Attribute (0x17/0):
      vendor id     = 0x0 (0)
      vendor scheme = assigned by intel
   ...
   (instruction supported synth):
      MWAIT = true
   (multi-processing synth) = multi-core (c=8)
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): CORE_width=5 SMT_width=1
   (APIC synth): PKG_ID=0 CORE_ID=12 SMT_ID=0
   (uarch synth) = Intel Gracemont, Intel 7
   (synth) = Intel Core i*-13000 E-core (Raptor Lake-P Q0) [Gracemont], Intel 7
CPU 5:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      processor type  = primary processor (0)
   ...
   TMUL Information (0x1e/0):
      ...
      tmul_maxn = 0x0 (0)
   V2 extended topology (0x1f):
      x2APIC ID of logical processor = 0x1a (26)
      --- level 0 ---
      level number                          = 0x0 (0)
      level type                            = thread (1)
      bit width of level & previous levels  = 0x1 (1)
...
CPU 6:
   ...
   version information (1/eax):
      ...
      (model synth)   = 0xba (186)
   miscellaneous (1/ebx):
      process local APIC physical ID = 0x1c (28)
      maximum IDs for CPUs in pkg    = 0x40 (64)
      CLFLUSH line size              = 0x8 (8)
      brand index                    = 0x0 (0)
   brand id = 0x00 (0): unknown
   ...
   TMUL Information (0x1e/0):
      ...
      tmul_maxn = 0x0 (0)
   V2 extended topology (0x1f):
      x2APIC ID of logical processor = 0x1c (28)
      --- level 0 ---
      level number                          = 0x0 (0)
      level type                            = thread (1)
      bit width of level & previous levels  = 0x1 (1)
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): CORE_width=5 SMT_width=1
   (APIC synth): PKG_ID=0 CORE_ID=14 SMT_ID=0
   (uarch synth) = Intel Gracemont, Intel 7
   (synth) = Intel Core i*-13000 E-core (Raptor Lake-P Q0) [Gracemont], Intel 7
CPU 7:
   vendor_id = "GenuineIntel"
   version information (1/eax):
      ...
      (model synth)   = 0xba (186)
   miscellaneous (1/ebx):
      process local APIC physical ID = 0x1e (30)
      maximum IDs for CPUs in pkg    = 0x40 (64)
      CLFLUSH line size              = 0x8 (8)
      brand index                    = 0x0 (0)
   brand id = 0x00 (0): unknown
   ...
   TMUL Information (0x1e/0):
      ...
      tmul_maxn = 0x0 (0)
   V2 extended topology (0x1f):
      x2APIC ID of logical processor = 0x1e (30)
      --- level 0 ---
      level number                          = 0x0 (0)
      level type                            = thread (1)
      bit width of level & previous levels  = 0x1 (1)
   ...
   (multi-processing method) = Intel leaf 0x1f
   (APIC widths synth): CORE_width=5 SMT_width=1
   (APIC synth): PKG_ID=0 CORE_ID=15 SMT_ID=0
   (uarch synth) = Intel Gracemont, Intel 7
   (synth) = Intel Core i*-13000 E-core (Raptor Lake-P Q0) [Gracemont], Intel 7
